...
// CloudV1alpha1Client is used to interact with features provided by the cloud.ecosysbin.com group.
type CloudV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudV1alpha1Client) Vclusters(namespace string) VclusterInterface {
	return newVclusters(c, namespace)
}
